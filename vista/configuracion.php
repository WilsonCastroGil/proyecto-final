...
<div class="container mt-3">
		...
		<div class="row ">
			...
			<div class="col-sm text-center">
				...
				<button type="button" class="btn btn-verde w-75 h-50 bordes2" data-toggle="modal" data-target="#modalcentro">
...
<section class="container-fluid bg ">
	...
	<div class="row justify-content-center">
		...
		<section class="col-sm-1 col-md-10 ">
			...
			<form class="form-container config" action="" method="POST" id="formRegistroUser">
