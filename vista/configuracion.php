...
<div class="container mt-3">
	...
	<div class="row ">
		...
		<div class="col-sm text-center">
			<button type="button" class="btn btn-verde w-75 h-50 bordes2 " data-toggle="modal" data-target="#modalficha">
					...
					<div class="modal-content">
						<form action="" id="formficha" method="POST">
							<div class="modal-header config">
								<h5 class="modal-title" id="exampleModalLabel">Config ficha</h5>
							...
							<div class="modal-body">
								<div class="container ">
									<div class="form-group row-8">
										...
										<label for="inputState"><span class="verde">programa</span></label>
									...
									<div class="form-group row">
										...
										<div class="col">
											<label for="ambiente" class="col-form-label verde">Fecha inicio:</label>
											<input type="date" name="fechaInicio" class="form-control">
										</div>


										<div class="col">
											<label for="ambiente" class="col-form-label verde">Fecha fin:</label>
									...
									<div class="form-group row">
										...
										<div class="col">
											<label for="inputAddress"><span class="verde">Cantidad de aprendices</span></label>
										...
										<div class="col">
											<label for="inputAddress"><span class="verde"># FICHA</span></label>
		...
		<div class="col-sm text-center">
			...
			<button type="button" class="btn btn-verde w-75 h-50 bordes2" data-toggle="modal" data-target="#modalsede">
		...
		<div class="col-sm text-center">
			<button type="button" class="btn btn-verde w-75 h-50 bordes2" data-toggle="modal" data-target="#modalcompetencia">
							...
							<div class="modal-body">
								...
								<section class="container">
									...
									<div class="form-gruop row-8">
										...
										<label for="inputState"><span class="verde">Nombre competencia</span></label>
									...
									<div class="form-gruop row-8">
										...
										<label for="inputState"><span class="verde">Código competencia</span></label>
		...
		<div class="col-sm text-center">
			...
			<button type="button" class="btn btn-verde w-75 h-50 bordes2" data-toggle="modal" data-target="#modalmateria">
			...
			<div class="modal fade" id="modalmateria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<form id="guardarmateria" method="POST">
							<div class="modal-header config">
								<h5 class="modal-title" id="exampleModalLabel">Ingresar materia</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							<div class="modal-body">
								<section class="container">
									...
									<div class="form-gruop row-8">
										...
										<label for="inputState"><span class="verde">Nombre materia</span></label>
										<input type="text" class="form-control" name="nombremat">
							...
							<div class="modal-footer config">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
								<button type="button" onclick="savemateria()" class="btn btn-verde">Registrar</button>
							</div>
							<article id="alertamat" class="alert-warning text-danger"></article>
...
<section class="container-fluid  ">
	...
	<div class="row justify-content-center">
		...
		<section class=" row-md-10 ">


			<form class="form-container p-2 config" action="" method="POST" id="formRegistroUser">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						<label for="inputAddress"><span class="verde">Documento o contraseña</span></label>
					...
					<div class="form-group col-md-3">
						...
						<input name="nombre" type="text" class="form-control " minlenght="6" id="inputAddress2" placeholder="Primer y/o segundo nombre">
					</div>
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						<label for="inputAddress2"><span class="verde">Correo</span></label>
				...
				<p class="text-right text-dark font-weight-bold">¡para modificar(actualizar) un usuario debe poner el mismo # de documento !</p>
